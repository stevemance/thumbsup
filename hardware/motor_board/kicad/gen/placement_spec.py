...
EXPLICIT["TP12"] = (17.15, 24.65, 0, T, "GND test pad: near the logic, off U1's footprint (routing)")
...
EXPLICIT["TP8"] = (17.6, 27.1, 0, T, "DRV_OFF test pad: top, in free space on the net, off U1's footprint (routing)")
