...
EXPLICIT["TP2"] = (33.4, 20.25, 0, T, "SWDIO probe pad: top, over U1's front pin row once its fan-out was done (the only free top spot near the net; routing)")
EXPLICIT["TP3"] = (14.95, 25.5, 0, T, "SWCLK pad: top, beside J1 (routing)")
EXPLICIT["TP4"] = (35.55, 20.25, 0, T, "NRST probe pad: top, over U1's NRST pin (routing)")
...
add("C90", B, ("U1", "34"), "drive R CSA A filter cap at the MCU pin (east of C91: the bus's outer lane drops into it first)")
add("C91", B, ("U1", "35"), "drive R CSA B filter cap at the MCU pin")
add("C92", B, ("U1", "25"), "drive R CSA C filter cap at the MCU pin")
EXPLICIT["R80"] = (63.62, 28.68, 90, T, "drive R CSA A filter resistor: top, below U4's lower-left corner in line from its SOA pin; the filtered net rides the east bus to C90 (routing)")
EXPLICIT["R81"] = (62.55, 28.68, 90, T, "drive R CSA B filter resistor: top, beside R80, in line from U4's SOB pin (routing)")
EXPLICIT["R82"] = (41.7, 25.6, 90, T, "drive R CSA C filter resistor: top, over U1's right column beside its output pin U1.25 (routing)")
