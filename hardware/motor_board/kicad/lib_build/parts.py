...
STOCK = {
    "STM32G474RET6": dict(src=("MCU_ST_STM32G4", "STM32G474RETx"), ref="U",
    ...
    "INA239AIDGSR": dict(src=("Sensor_Energy", "INA229"), ref="U",
    ...
    # 4A 12, 4B 13, VCC 14
    "SN74LVC08APWR": dict(src=("74xx", "74LS08"), ref="U",
    ...
    "74LVC1G17SE-7": dict(src=("74xGxx", "74LVC1G17"), ref="U", rename={"2": "A", "4": "Y"},
    ...
    "SN74LVC3G17DCUR": dict(src=("74xGxx", "74LVC3G17"), ref="U",
    ...
    "AP2112K-3.3TRG1": dict(src=("Regulator_Linear", "AP2112K-3.3"), ref="U",
    ...
    "HYG015N04LS1C2": dict(src=("Transistor_FET", "Q_NMOS_SSSGD_AvalancheRated"), ref="Q",
    ...
    "BAV99": dict(src=("Diode", "BAV99"), ref="D", rename={"1": "A1", "2": "K2", "3": "K1A2"},
    ...
    "B5819W": dict(src=("Device", "D_Schottky"), ref="D", desc="Schottky 40 V 1 A, SOD-123",
        datasheet="", fp="Diode_SMD:D_SOD-123"),
    "KT-0603R": dict(src=("Device", "LED"), ref="D", desc="LED red 0603 (KENTO KT-0603R)",
        datasheet="", fp="LED_SMD:LED_0603_1608Metric"),
    "FNR5040S220MT": dict(src=("Device", "L"), ref="L", desc="22 uH 1.6 A shielded inductor 5x5x4 (Changjiang FNR5040S220MT)",
        datasheet="", fp="Inductor_SMD:L_Changjiang_FNR5040S"),
    "EEHZK1V331P": dict(src=("Device", "C_Polarized"), ref="C", desc="330 uF 35 V hybrid polymer 10x10.2 (Panasonic EEH-ZK1V331P)",
        datasheet="", fp="Capacitor_SMD:CP_Elec_10x10.5"),
    "HoLR2512-3W-2mR": dict(src=("Device", "R"), ref="R", desc="2 mOhm 1% 3 W 2512 alloy shunt (Milliohm HoLR2512)",
        datasheet="", fp="motor_board:R_2512_HoLR_1-4mR"),
    "RE2512F3R001": dict(src=("Device", "R"), ref="R", desc="1 mOhm 1% 3 W 2512 shunt (JIERR RE2512F3R001)",
        datasheet="", fp="Resistor_SMD:R_2512_6332Metric"),
    "25121WF100LT4E": dict(src=("Device", "R"), ref="R", desc="0.1 Ohm 1% 1 W 2512 (UNI-ROYAL 25121WF100LT4E)",
        datasheet="", fp="Resistor_SMD:R_2512_6332Metric"),
    "BOOMELE_1.27-2x10P": dict(src=("Connector_Generic", "Conn_02x10_Odd_Even"), ref="J",
        desc="2x10 1.27 mm SMD male header, 5.5 mm lead span (BOOMELE 1.27-2*10P)",
        datasheet="", fp="motor_board:BOOMELE_1.27-2x10P_SMD"),
    "WAFER-SH1.0-6PWB": dict(src=("Connector_Generic_MountingPin", "Conn_01x06_MountingPin"), ref="J",
    ...
    "S5B-XH-A": dict(src=("Connector_Generic", "Conn_01x05"), ref="J",
